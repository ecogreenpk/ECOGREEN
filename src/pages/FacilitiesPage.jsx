          ...
          <div className="content-section">
            ...
            <div className="facilities-grid">
              <div className="facility-card">
                <img src="/images/pictures/facility/machine cu.webp" alt="Treatment Plant" className="card-img-top" loading="eager" width="800" height="450" />
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/shredders.webp" alt="Recycling Facility" className="card-img-top" loading="eager" width="800" height="450" />
                <div className="card-content">
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/storage.webp" alt="Storage Warehouses" className="card-img-top" loading="eager" width="800" height="450" />
                <div className="card-content">
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/machinery.webp" alt="Vehicle Fleet & Equipment" className="card-img-top" loading="eager" width="800" height="450" />
                <div className="card-content">
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/laboratory.webp" alt="Laboratory Monitoring" className="card-img-top" loading="eager" width="800" height="450" />
                <div className="card-content">
                  <h3>Laboratory</h3>
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/processing.webp" alt="Administrative Hub" className="card-img-top" loading="eager" width="800" height="450" />
                <div className="card-content">
