          ...
          <div className="content-section">
            ...
            <div className="facilities-grid">
              <div className="facility-card">
                <img src="/images/pictures/facility/machine cu.png" alt="Treatment Plant" className="card-img-top" loading="lazy" width="800" height="450" />
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/shredders.png" alt="Recycling Facility" className="card-img-top" loading="lazy" width="800" height="450" />
                <div className="card-content">
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/storage.jfif" alt="Storage Warehouses" className="card-img-top" loading="lazy" width="800" height="450" />
                <div className="card-content">
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/machinery.png" alt="Vehicle Fleet & Equipment" className="card-img-top" loading="lazy" width="800" height="450" />
                <div className="card-content">
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/laboratory.jfif" alt="Laboratory Monitoring" className="card-img-top" loading="lazy" width="800" height="450" />
                <div className="card-content">
                  <h3>Laboratory</h3>
              ...
              <div className="facility-card">
                <img src="/images/pictures/facility/processing.jfif" alt="Administrative Hub" className="card-img-top" loading="lazy" width="800" height="450" />
                <div className="card-content">
